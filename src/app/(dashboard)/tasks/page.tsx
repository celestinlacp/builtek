...
export default async function TasksPage() {
  ...
  const [projectsRes, tasksRes, docsRes, driveRes, membersRes] = await Promise.all([
    supabase.from('projects')
      .select('id, name, status, workspace_id, description, start_date, end_date, created_at, frente, project_type, cover_image_url, parent_project_id, chainage_start, chainage_end')
